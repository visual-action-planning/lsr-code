...
data_train_opt['dataset_name'] = 'action_VAE_ShirtFolding_Linf'
...
data_test_opt['dataset_name'] = 'action_VAE_ShirtFolding_Linf'
...
model_opt = {
    'filename': 'apnet', 
    'vae_name': 'VAE_ShirtFolding_Linf', # to decode samples with
