...
data_train_opt['dataset_name'] = 'action_VAE_UnityStacking_L2'
...
data_test_opt['dataset_name'] = 'action_VAE_UnityStacking_L2'
...
model_opt = {
    'filename': 'apnet', 
    'vae_name': 'VAE_UnityStacking_L2', # to decode samples with
