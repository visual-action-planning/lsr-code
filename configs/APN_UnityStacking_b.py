...
data_train_opt['dataset_name'] = 'action_VAE_UnityStacking_b'
...
data_test_opt['dataset_name'] = 'action_VAE_UnityStacking_b'
...
model_opt = {
    'filename': 'apnet', 
    'vae_name': 'VAE_UnityStacking_b', # to decode samples with
