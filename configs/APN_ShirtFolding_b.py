...
data_train_opt['dataset_name'] = 'action_VAE_ShirtFolding_b'
...
data_test_opt['dataset_name'] = 'action_VAE_ShirtFolding_b'
...
model_opt = {
    'filename': 'apnet', 
    'vae_name': 'VAE_ShirtFolding_b', # to decode samples with
